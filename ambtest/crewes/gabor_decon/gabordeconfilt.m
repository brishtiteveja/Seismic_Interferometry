function [trout,tvs_op]=gabordeconfilt(trin,t,twin,tinc,tsmo,fsmo,ihyp,stab,phase,p,gdb,filtmask)
% GABORDECONFILT: nonstationary seismic deconvolution using the Gabor transform plus filtering
%
% [trout,tvs_op]=gabordeconfilt(trin,t,twin,tinc,tsmo,fsmo,ihyp,stab,phase,p,gdb,t1,fmin,fmax,fmaxlim,fphase,max_atten)
%
