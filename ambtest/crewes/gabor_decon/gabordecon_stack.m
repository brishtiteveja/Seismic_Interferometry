function stackg=gabordecon_stack(stack,t,twin,tinc,tsmo,fsmo,ihyp,stab,phase,iwait,ievery)
% GABORDECON_STACK: applies gabor decon to a stacked section
%
% stackg=gabordecon_stack(stack,t,twin,tinc,tsmo,fsmo,ihyp,stab,phase,iwait,ievery)
%
