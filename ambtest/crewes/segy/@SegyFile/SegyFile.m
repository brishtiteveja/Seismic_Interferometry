...
events
    ...
    SampleIntervalChanged;%Notifies listeners that the SamplesInterval has changed    
end
...
%         obj.Debug=true;
        ...
        if(obj.Debug),disp('Creating BinaryHeader');end
        ...
        if ~strncmpi(obj.Permission,'w',1)
            ...
            %This only needs to happen ifwe are reading an existing file            
        ...
        %Transfer some info from BinaryHeader to SegyFile;
        ...
        if(obj.Debug),disp('Creating TextHeader');end
        ...
        if(obj.Debug),disp('Creating ExtendedTextHeader');end
        ...
        %Create trace object
        if(obj.Debug),disp('Creating Trace');end        
    ...
    function obj = listenByteOrder(obj, varargin)
        ...
        if ~isempty(obj.FileName)
             ...
             if ~isempty(obj.BinaryHeader)
                 ...
                 if obj.fsize >= obj.BinaryHeader.SIZE +obj.BinaryHeader.OFFSET
    ...
    function obj = listenPermission(obj, varargin)
        ...
        if(obj.Debug), disp('in SegyFile.listenPermission'); end
        if ~isempty(obj.FileName)
            obj.freopen();
            obj.TextHeader.FileID = obj.FileID;
            obj.BinaryHeader.FileID = obj.FileID;
    ...
    function obj = listenSegyRevision(obj, varargin)
        ...
        if(obj.Debug), disp('in SegyFile.listenSegyRevision'); end
    ...
    function obj = listenTextFormat(obj, varargin)
        ...
        if(obj.Debug), disp('in SegyFile.listenTextFormat'); end
    ...
    function obj = listenFormatCode(obj, varargin)
        ...
        if(obj.Debug), disp('in SegyFile.listenFormatCode'); end
    ...
    function obj = listenGUI(obj, varargin)
        ...
        if(obj.Debug), disp('in SegyFile.listenGUI'); end
