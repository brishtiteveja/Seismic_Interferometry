...
%   >> [trcdat,trchdr,trcdef] = sf.Trc.read();
%   >> [trcdat,trchdr,trcdef] = sf.Trc.read(1:sf.Trc.TracesInFile);
%   >> [trcdat,trchdr,trcdef] = sf.Trc.read(1:sf.Trc.TracesInFile,'both');
%   >> [trcdat,trchdr,trcdef] = sf.Trc.read([],'both',true);
%
...
%   >> trcdat = sf.Trc.read(1:sf.Trc.TracesInFile,'data');
%   >> trcdat = sf.Trc.read([],'data');
%
...
%   trcdat = sf.Trc.read(100:2:200,'data');
